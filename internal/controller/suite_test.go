...
import (
	...
	v1alpha1 "github.com/validator-labs/validator-plugin-network/api/v1alpha1"
...
var _ = BeforeSuite(func() {
	...
	err = (&NetworkValidatorReconciler{
		Client: k8sManager.GetClient(),
		Log:    ctrl.Log.WithName("controllers").WithName("NetworkValidator"),
		Scheme: k8sManager.GetScheme(),
	}).SetupWithManager(k8sManager)
	Expect(err).ToNot(HaveOccurred(), "failed to start NetworkValidator controller")
