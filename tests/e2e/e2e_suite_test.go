...
var (
	...
	projectImage = "quay.io/validator-labs/validator-plugin-network:latest"
)
...
func TestE2E(t *testing.T) {
	...
	_, _ = fmt.Fprintf(GinkgoWriter, "Starting validator-plugin-network integration test suite\n")
